...
func (v *ingressValidator) ValidateCreate(ctx context.Context, obj runtime.Object) error {
	...
	if skip, err := v.checkIngressClass(ctx, ing); skip || err != nil {
		v.metricsCollector.ObserveWebhookValidationError("ingressValidator", "checkIngressClass")
		return err
	}
	if err := v.checkIngressClassAnnotationUsage(ing, nil); err != nil {
		v.metricsCollector.ObserveWebhookValidationError("ingressValidator", "checkIngressClassAnnotationUsage")
		return err
	}
	if err := v.checkGroupNameAnnotationUsage(ing, nil); err != nil {
		v.metricsCollector.ObserveWebhookValidationError("ingressValidator", "checkGroupNameAnnotationUsage")
		return err
	}
	if err := v.checkIngressClassUsage(ctx, ing, nil); err != nil {
		v.metricsCollector.ObserveWebhookValidationError("ingressValidator", "checkIngressClassUsage")
		return err
	}
	if err := v.checkIngressAnnotationConditions(ing); err != nil {
		v.metricsCollector.ObserveWebhookValidationError("ingressValidator", "checkIngressAnnotationConditions")
		return err
	}
	return nil
}
