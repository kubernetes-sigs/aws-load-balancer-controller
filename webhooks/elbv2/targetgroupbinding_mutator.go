...
func (m *targetGroupBindingMutator) MutateCreate(ctx context.Context, obj runtime.Object) (runtime.Object, error) {
	...
	if tgb.Spec.TargetGroupARN == "" && tgb.Spec.TargetGroupName == "" {
		m.metricsCollector.ObserveWebhookMutationError("TargetGroupBindingMutator", "checkTargetGroupArnOrName")
	...
	if err := m.getArnFromNameIfNeeded(ctx, tgb); err != nil {
		m.metricsCollector.ObserveWebhookMutationError("TargetGroupBindingMutator", "getArnFromNameIfNeeded")
		return nil, err
	}
	if err := m.defaultingTargetType(ctx, tgb); err != nil {
		m.metricsCollector.ObserveWebhookMutationError("TargetGroupBindingMutator", "defaultingTargetType")
		return nil, err
	}
	if err := m.defaultingIPAddressType(ctx, tgb); err != nil {
		m.metricsCollector.ObserveWebhookMutationError("TargetGroupBindingMutator", "defaultingIPAddressType")
		return nil, err
	}
	if err := m.defaultingVpcID(ctx, tgb); err != nil {
		m.metricsCollector.ObserveWebhookMutationError("TargetGroupBindingValidator", "defaultingVpcID")
		return nil, err
	}
	return tgb, nil
}
