...
const apiPathValidateELBv2TargetGroupBinding = "/validate-elbv2-k8s-aws-v1alpha1-targetgroupbinding"
...
// +kubebuilder:webhook:path=/validate-elbv2-k8s-aws-v1alpha1-targetgroupbinding,mutating=false,failurePolicy=fail,groups=elbv2.k8s.aws,resources=targetgroupbindings,verbs=create;update,versions=v1alpha1,name=vtargetgroupbinding.elbv2.k8s.aws,sideEffects=None,webhookVersions=v1beta1
