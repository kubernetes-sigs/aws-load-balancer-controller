...
func (m *MockSecurityGroupManager) AuthorizeSGIngress(arg0 context.Context, arg1 string, arg2 []networking.IPPermissionInfo) error {
	m.ctrl.T.Helper()
...
func (m *MockSecurityGroupManager) FetchSGInfosByID(arg0 context.Context, arg1 []string, arg2 ...networking.FetchSGInfoOption) (map[string]networking.SecurityGroupInfo, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(map[string]networking.SecurityGroupInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSecurityGroupManager) FetchSGInfosByRequest(arg0 context.Context, arg1 *ec2.DescribeSecurityGroupsInput) (map[string]networking.SecurityGroupInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockSecurityGroupManager) RevokeSGIngress(arg0 context.Context, arg1 string, arg2 []networking.IPPermissionInfo) error {
	m.ctrl.T.Helper()
