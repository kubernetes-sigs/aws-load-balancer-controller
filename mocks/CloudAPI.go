...
// GetTargetGroupsByTagFilters provides a mock function with given fields: ctx, tagFilters
func (_m *CloudAPI) GetTargetGroupsByTagFilters(ctx context.Context, tagFilters map[string][]string) ([]*elbv2.TargetGroup, error) {
	ret := _m.Called(ctx, tagFilters)

	var r0 []*elbv2.TargetGroup
	if rf, ok := ret.Get(0).(func(context.Context, map[string][]string) []*elbv2.TargetGroup); ok {
		r0 = rf(ctx, tagFilters)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*elbv2.TargetGroup)
		}
