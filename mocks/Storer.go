...
// GetClusterInstanceID provides a mock function with given fields:
func (_m *Storer) GetClusterInstanceID() (string, error) {
	ret := _m.Called()
...
func (_m *Storer) GetClusterInstanceIDs() ([]string, error) {
	ret := _m.Called()
...
func (_m *Storer) GetConfig() *config.Configuration {
	ret := _m.Called()
...
// GetConfigMap provides a mock function with given fields: key
func (_m *Storer) GetConfigMap(key string) (*v1.ConfigMap, error) {
	ret := _m.Called(key)
...
// GetIngress provides a mock function with given fields: key
func (_m *Storer) GetIngress(key string) (*v1beta1.Ingress, error) {
	ret := _m.Called(key)

	var r0 *v1beta1.Ingress
	if rf, ok := ret.Get(0).(func(string) *v1beta1.Ingress); ok {
		r0 = rf(key)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Storer) GetIngressAnnotations(key string) (*annotations.Ingress, error) {
	ret := _m.Called(key)
...
func (_m *Storer) GetInstanceIDFromPodIP(_a0 string) (string, error) {
	ret := _m.Called(_a0)
...
func (_m *Storer) GetNodeInstanceID(node *v1.Node) (string, error) {
	ret := _m.Called(node)
...
func (_m *Storer) GetService(key string) (*v1.Service, error) {
	ret := _m.Called(key)
...
func (_m *Storer) GetServiceAnnotations(key string, ingress *annotations.Ingress) (*annotations.Service, error) {
...
func (_m *Storer) GetServiceEndpoints(key string) (*v1.Endpoints, error) {
	ret := _m.Called(key)
...
// ListIngresses provides a mock function with given fields:
func (_m *Storer) ListIngresses() []*v1beta1.Ingress {
	ret := _m.Called()

	var r0 []*v1beta1.Ingress
	if rf, ok := ret.Get(0).(func() []*v1beta1.Ingress); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*v1beta1.Ingress)
...
func (_m *Storer) ListNodes() []*v1.Node {
	ret := _m.Called()
...
func (_m *Storer) Run(stopCh chan struct{}) {
	_m.Called(stopCh)
}
