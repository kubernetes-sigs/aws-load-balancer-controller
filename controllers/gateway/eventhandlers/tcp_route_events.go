...
func NewEnqueueRequestsForTCPRouteEvent(
	k8sClient client.Client, eventRecorder record.EventRecorder, logger logr.Logger) handler.TypedEventHandler[*gwv1.TCPRoute, reconcile.Request] {
...
var _ handler.TypedEventHandler[*gwv1.TCPRoute, reconcile.Request] = (*enqueueRequestsForTCPRouteEvent)(nil)
...
func (h *enqueueRequestsForTCPRouteEvent) Create(ctx context.Context, e event.TypedCreateEvent[*gwv1.TCPRoute], queue workqueue.TypedRateLimitingInterface[reconcile.Request]) {
	routeNew := e.Object
	h.logger.V(1).Info("enqueue tcproute create event", "tcproute", routeNew.Name)
	h.enqueueImpactedGateways(ctx, routeNew, queue)
}

func (h *enqueueRequestsForTCPRouteEvent) Update(ctx context.Context, e event.TypedUpdateEvent[*gwv1.TCPRoute], queue workqueue.TypedRateLimitingInterface[reconcile.Request]) {
	routeNew := e.ObjectNew
	h.logger.V(1).Info("enqueue tcproute update event", "tcproute", routeNew.Name)
	h.enqueueImpactedGateways(ctx, routeNew, queue)
}

func (h *enqueueRequestsForTCPRouteEvent) Delete(ctx context.Context, e event.TypedDeleteEvent[*gwv1.TCPRoute], queue workqueue.TypedRateLimitingInterface[reconcile.Request]) {
	route := e.Object
	h.logger.V(1).Info("enqueue tcproute delete event", "tcproute", route.Name)
	h.enqueueImpactedGateways(ctx, route, queue)
}

func (h *enqueueRequestsForTCPRouteEvent) Generic(ctx context.Context, e event.TypedGenericEvent[*gwv1.TCPRoute], queue workqueue.TypedRateLimitingInterface[reconcile.Request]) {
	route := e.Object
	h.logger.V(1).Info("enqueue tcproute generic event", "tcproute", route.Name)
	h.enqueueImpactedGateways(ctx, route, queue)
}

func (h *enqueueRequestsForTCPRouteEvent) enqueueImpactedGateways(ctx context.Context, route *gwv1.TCPRoute, queue workqueue.TypedRateLimitingInterface[reconcile.Request]) {
