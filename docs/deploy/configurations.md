...
| cache-sync-timeout                                                              | duration                        | 2m0s                                       | Time limit for waiting on controller caches to sync during startup. Increase on clusters with a large number of Services or Gateway API resources                             |
