...
| [service.beta.kubernetes.io/aws-load-balancer-quic-enabled-ports](#nlb-quic-enabled)                                 | boolean                  | false                    | If specified, the controller will upgrade each port specified from UDP -> QUIC or TCP_UDP -> TCP_QUIC.                                                                                                                                                                                                                                                                                                               |
