...
| [service.beta.kubernetes.io/actions.${protocol}-${port}](#nlb-default-action)                      | stringMap                                      |                     | If specified, the controller will add the specified action on the listener denoted by the port.                                                                                                                                                                                                                                                                                                                      |
