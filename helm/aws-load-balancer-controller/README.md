...
| `ingressClass`                              | The ingress class to satisfy                                                                             | alb                                                                                |                                                                             |
| `createIngressClassResource`                | Create ingressClass resource                                                                             | true 
| `createIngressClassParamsResource`          | Create ingressClassParams resource                                                                       | false
| `createIngressClassParamsGroup`             | Create group specification in ingressClassParams                                                         | false
| `createIngressClassParamsNamespaceSelector` | Create namespaceSelector specification in ingressClassParams                                             | false
| `createIngressClassParamsScheme`            | Create scheme specification in ingressClassParams                                                        | false
| `ingressClassParams.name`                   | IngressClassParams resource's name                                                                       | None
| `ingressClassParams.group`                  | IngressClassParams' specification group's name                                                           | None
| `ingressClassParams.scheme`                 | IngressClassParams' specification scheme                                                                 | None
| `ingressClassParams.ipAddressType`          | IngressClassParams' specification ipAddressType                                                          | None
| `ingressClassParams.tags`                   | IngressClassParams' specification tags                                                                   | `[]`
| `ingressClassParams.namespaceSelector.matchLabels`            | IngressClassParams' specification namespaceSelector                                    | `{}`
| `region`                                    | The AWS region for the kubernetes cluster                                                                | None                                                                               |
| `vpcId`                                     | The VPC ID for the Kubernetes cluster                                                                    | None                                                                               |
| `awsMaxRetries`                             | Maximum retries for AWS APIs                                                                             | None                                                                               |
| `enablePodReadinessGateInject`              | If enabled, targetHealth readiness gate will get injected to the pod spec for the matching endpoint pods | None                                                                               |
