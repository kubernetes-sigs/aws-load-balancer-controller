...
| `prometheusRule.enabled`                       | Specifies whether a prometheus rule should be created, requires the PrometheusRule CRD to be installed                                                                                                                 | `false`                                           |
| `prometheusRule.additionalLabels`              | Labels to add to the prometheus rule                                                                                                                                                                                   | `{}`                                              |
| `prometheusRule.namespace`                     | Namespace to create the prometheus rule in                                                                                                                                                                               | None                                              |
