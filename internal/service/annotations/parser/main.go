...
var (
	...
	ALBAnnotationsPrefix = "alb.ingress.kubernetes.io"
	NLBAnnotationsPrefix = "nlb.service.kubernetes.io"
)
...
// GetServiceAnnotationWithPrefix returns the prefix of service annotations
func GetServiceAnnotationWithPrefix(suffix string) string {
	return fmt.Sprintf("%v/%v", NLBAnnotationsPrefix, suffix)
}
