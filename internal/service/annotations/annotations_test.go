...
var (
	annotationHealthcheckIntervalSeconds = parser.GetIngressAnnotationWithPrefix("healthcheck-interval-seconds")
	annotationScheme                     = parser.GetIngressAnnotationWithPrefix("scheme")
	annotationSubnets                    = parser.GetIngressAnnotationWithPrefix("subnets")
)
