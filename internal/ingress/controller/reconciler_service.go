...
// ServiceReconciler reconciles an single ingress object
...
func (r *ServiceReconciler) reconcileService(ctx context.Context, serviceKey types.NamespacedName, service *corev1.Service) error {
...
func (r *ServiceReconciler) deleteService(ctx context.Context, serviceKey types.NamespacedName) error {
...
func (r *ServiceReconciler) updateServiceStatus(ctx context.Context, service *corev1.Service, lbInfo *lb.LoadBalancer) error {
...
func (r *ServiceReconciler) buildReconcileContext(ctx context.Context, serviceKey types.NamespacedName, service *corev1.Service) context.Context {
