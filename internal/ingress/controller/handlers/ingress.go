...
func (h *EnqueueRequestsForIngressEvent) Create(e event.CreateEvent, queue workqueue.RateLimitingInterface) {
	h.enqueueIfIngressClassMatched(e.Object.(*networking.Ingress), queue)
}

// Update is called in response to an update event -  e.g. Pod Updated.
func (h *EnqueueRequestsForIngressEvent) Update(e event.UpdateEvent, queue workqueue.RateLimitingInterface) {
	h.enqueueIfIngressClassMatched(e.ObjectOld.(*networking.Ingress), queue)
	h.enqueueIfIngressClassMatched(e.ObjectNew.(*networking.Ingress), queue)
}
...
func (h *EnqueueRequestsForIngressEvent) enqueueIfIngressClassMatched(ingress *networking.Ingress, queue workqueue.RateLimitingInterface) {
