...
func Test_buildFrontendNlbName(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, err := task.buildFrontendNlbName(context.Background(), tt.scheme)
			fmt.Print("got", got)
...
func Test_buildFrontendNLBTargetGroupName(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			wantPrefix:  "k8s-default-default",
		},
	}
...
func Test_buildEnableFrontendNlbViaAnnotation(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			got, _, err := task.buildEnableFrontendNlbViaAnnotation(context.Background())
