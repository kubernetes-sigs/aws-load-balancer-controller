...
import (
	...
	"sigs.k8s.io/aws-load-balancer-controller/v3/pkg/deploy/wafv2"
...
func NewDefaultStackDeployer(cloud services.Cloud, k8sClient client.Client,
	...
	return &defaultStackDeployer{
		...
		acmManager:                          acm.NewDefaultCertificateManager(cloud.ACM(), cloud.Route53(), config.IngressConfig.DefaultPCAArn, trackingProvider, logger, config.ClusterName, config.IngressConfig.Route53ValidationRecordRoutingPolicy, config.IngressConfig.Route53ValidationRecordWeight),
