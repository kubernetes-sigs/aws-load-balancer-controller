...
// Source: sigs.k8s.io/aws-load-balancer-controller/v3/pkg/deploy/tracking (interfaces: Provider)
...
import (
	...
	core "sigs.k8s.io/aws-load-balancer-controller/v3/pkg/model/core"
)
