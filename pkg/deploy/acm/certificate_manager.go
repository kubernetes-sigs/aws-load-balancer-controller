...
type CertificateManager interface {
	...
	WaitForCertificateWithContext(ctx context.Context, arn string, waitTime time.Duration) error
...
func (c *defaultCertificateManager) WaitForCertificateWithContext(ctx context.Context, arn string, waitTime time.Duration) error {
	err := c.acmClient.WaitForCertificateWithContext(ctx, arn, waitTime)
	if err != nil {
		return err
	}
