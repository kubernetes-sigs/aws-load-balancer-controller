...
// Define a test-only DNSResolverForTest to avoid dependency on the DNSResolver implementation
type DNSResolverForTest interface {
	ResolveDNSToARN(ctx context.Context, dnsName string) (string, error)
}
...
func TestLoadEndpoint_Service(t *testing.T) {
	...
	mockDNSResolver.EXPECT().
		ResolveDNSToARN(gomock.Any(), "test-lb-1234567890.us-west-2.elb.amazonaws.com").
...
func TestLoadEndpoint_Ingress(t *testing.T) {
	...
	// Set up expectations
	mockDNSResolver.EXPECT().
		ResolveDNSToARN(gomock.Any(), "test-ing-1234567890.us-west-2.elb.amazonaws.com").
...
func TestLoadEndpoint_Gateway(t *testing.T) {
	...
	// Set up expectations
	mockDNSResolver.EXPECT().
		ResolveDNSToARN(gomock.Any(), "test-gw-1234567890.us-west-2.elb.amazonaws.com").
...
func TestLoadEndpoint_EndpointID(t *testing.T) {
	...
	// Create mock DNS resolver (not used for EndpointID)
	mockDNSResolver := NewMockDNSResolverForTest(ctrl)
...
// ResolveDNSToARN mocks the ResolveDNSToARN method
func (m *MockDNSResolverForTestMockRecorder) ResolveDNSToARN(ctx, dnsName interface{}) *gomock.Call {
	return m.mock.ctrl.RecordCallWithMethodType(m.mock, "ResolveDNSToARN", reflect.TypeOf((*MockDNSResolverForTest)(nil).ResolveDNSToARN), ctx, dnsName)
}

// ResolveDNSToARN is the mock implementation
func (m *MockDNSResolverForTest) ResolveDNSToARN(ctx context.Context, dnsName string) (string, error) {
	ret := m.ctrl.Call(m, "ResolveDNSToARN", ctx, dnsName)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
