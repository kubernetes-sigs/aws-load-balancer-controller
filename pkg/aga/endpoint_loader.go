...
func NewEndpointLoader(k8sClient client.Client, dnsResolver DNSResolverInterface, logger logr.Logger) EndpointLoader {
...
func (l *endpointLoaderImpl) LoadEndpoint(ctx context.Context, endpoint *agaapi.GlobalAcceleratorEndpoint, defaultNamespace string) *LoadedEndpoint {
	...
	weight := int32(128) // Default weight
...
func (l *endpointLoaderImpl) loadResourceWithDNS(
	...
	// Resolve DNS to ARN
	arn, err := l.dnsResolver.ResolveDNSToARN(ctx, dnsName)
	if err != nil {
