...
func newInstruments(registerer prometheus.Registerer) *instruments {
	...
	registerer.MustRegister(podReadinessFlipSeconds, controllerReconcileErrors, controllerReconcileStageDuration, webhookValidationFailure, webhookMutationFailure, controllerCacheObjectCount)
	return &instruments{
