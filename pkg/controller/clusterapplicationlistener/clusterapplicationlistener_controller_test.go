...
func TestReconcile(t *testing.T) {
	...
	instance := &ingressv1alpha1.ClusterApplicationListener{ObjectMeta: metav1.ObjectMeta{Name: "foo"}}
	...
	// Create the ClusterApplicationListener object and expect the Reconcile and Deployment to be created
