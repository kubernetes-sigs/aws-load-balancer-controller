...
func TestReconcile(t *testing.T) {
	...
	instance := &ingressv1alpha1.ClusterApplicationListenerRule{ObjectMeta: metav1.ObjectMeta{Name: "foo"}}
	...
	// Create the ClusterApplicationListenerRule object and expect the Reconcile and Deployment to be created
