...
func TestReconcile(t *testing.T) {
	...
	instance := &ingressv1alpha1.ClusterApplicationLoadBalancer{ObjectMeta: metav1.ObjectMeta{Name: "foo"}}
	...
	// Create the ClusterApplicationLoadBalancer object and expect the Reconcile and Deployment to be created
