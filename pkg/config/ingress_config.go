...
const (
	...
	flagDefaultCAARN                         = "default-ca-arn"
...
func (cfg *IngressConfig) BindFlags(fs *pflag.FlagSet) {
	...
	fs.StringVar(&cfg.DefaultCAArn, flagDefaultCAARN, defaultDefaultCAArn, "Default CA ARN to use for creating ACM certificates")
}
